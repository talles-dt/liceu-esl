  ...
  return (
    <main className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="text-center space-y-4">
        <h1 className="text-3xl font-bold">Lexio Underground</h1>
        <p className="text-muted-foreground">
          Ambiente não configurado. Defina suas credenciais do Supabase em{" "}
    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold">Lexio Underground</h1>
          <p className="text-muted-foreground mt-2">Evolua seu idioma.</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-secondary text-secondary-foreground font-semibold rounded-lg hover:bg-secondary/80 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 border border-border text-foreground font-semibold rounded-lg hover:bg-secondary/60 transition disabled:opacity-50"
          >
